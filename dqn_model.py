...
class GridEnvironment:
    ...
    def step(self, action):
        ...
        #Base penalty: -1 per step (encourages finding shortest path)
...
class DQNAgent:
    ...
    def replay(self, batch_size):
        ...
        #Create tensor of done flags (0 or 1) [batch_size]
        ...
        #===== Calculate Q-values for actions taken (Main Network) =====
        ...
        #===== Calculate Target Q-values (Target Network) =====
        ...
        #max(dim=1)[0] gets the values (dim=1)[1] would get indices)
        #Result shape: [batch_size]
        next_q_values = next_q_values.max(dim=1)[0]
        
        #Apply Bellman Equation: Q(s,a) = r + γ * max(Q(s',a')) * (1 - done)
